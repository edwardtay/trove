...
`,y=l.I4.div`
  ...
  padding: 2rem 0;
`},61976:(e,t,r)=>{r.d(t,{O:()=>n});let n="sdk_fiat_on_ramp_completed_with_status"},83361:(e,t,r)=>{r.d(t,{B:()=>i,C:()=>l,F:()=>d,H:()=>o,R:()=>g,S:()=>u,a:()=>c,b:()=>f,c:()=>s,d:()=>p,e:()=>a});var n=r(20031);let i=n.I4.div`
  display: flex;
  flex-direction: column;
