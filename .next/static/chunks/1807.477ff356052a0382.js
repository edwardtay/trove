"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[1807],{18801:(e,r,t)=>{t.d(r,{S:()=>o});var i=t(95155),a=t(84241),n=t(87584);let o=({primaryCta:e,secondaryCta:r,helpText:t,footerText:o,watermark:l=!0,children:s,...c})=>{let d=e||r?(0,i.jsxs)(i.Fragment,{children:[e&&(()=>{let{label:r,...t}=e,n=t.variant||"primary";return(0,i.jsx)(a.a,{...t,variant:n,style:{width:"100%",...t.style},children:r})})(),r&&(()=>{let{label:e,...t}=r,n=t.variant||"secondary";return(0,i.jsx)(a.a,{...t,variant:n,style:{width:"100%",...t.style},children:e})})()]}):null;return(0,i.jsxs)(n.S,{id:c.id,className:c.className,children:[(0,i.jsx)(n.S.Header,{...c}),s?(0,i.jsx)(n.S.Body,{children:s}):null,t||d||l?(0,i.jsxs)(n.S.Footer,{children:[t?(0,i.jsx)(n.S.HelpText,{children:t}):null,d?(0,i.jsx)(n.S.Actions,{children:d}):null,l?(0,i.jsx)(n.S.Watermark,{}):null]}):null,o?(0,i.jsx)(n.S.FooterText,{children:o}):null]})}},40355:(e,r,t)=>{t.d(r,{s:()=>a});var i=t(41078);let a=(e,r)=>(0,i.s)(e,r.ethereum.createOnLogin)||(0,i.k)(e,r.solana.createOnLogin)},51807:(e,r,t)=>{t.r(r),t.d(r,{TelegramAuthScreen:()=>g,TelegramAuthScreenView:()=>p,default:()=>g});var i=t(95155),a=t(12115),n=t(41078),o=t(64209),l=t(90456),s=t(17411),c=t(40355),d=t(18801),u=t(56967);t(68463),t(92253),t(72378),t(45472),t(50205);let p=({success:e,errorMessage:r,onRetry:t})=>{let a=e?"Successfully connected with Telegram":r?r.message:"Verifying connection to Telegram";return(0,i.jsx)(d.S,{title:a,subtitle:e?"You're good to go!":r?r.detail:"Just a few moments more",icon:u.T,iconVariant:"loading",iconLoadingStatus:{success:e,fail:!!r},secondaryCta:r?.retryable&&t?{label:"Retry",onClick:t}:void 0,watermark:!0})},g={component:()=>{let{authenticated:e,logout:r,ready:t,user:d}=(0,s.u)(),{setModalData:u,navigate:g,resetNavigation:h,data:v}=(0,s.a)(),x=(0,o.u)(),{initLoginWithTelegram:m,loginWithTelegram:f,updateWallets:y,setReadyToTrue:b,closePrivyModal:w,createAnalyticsEvent:j,getAuthMeta:S}=(0,l.u)(),[k,E]=(0,a.useState)(!1),[I,T]=(0,a.useState)(void 0),A=(0,n.a)();async function C(){try{let r=await async function(){let r;if(!e){if(A.enabled&&"error"===A.status)throw new n.C(A.error,null,l.c.CAPTCHA_FAILURE);return A.enabled&&"success"!==A.status&&(A.execute(),r=await A.waitForResult()),r}}();await f({captchaToken:r}),E(!0),b(!0)}catch(t){if(t?.privyErrorCode===l.c.ALLOWLIST_REJECTED)return T(void 0),h(),void g("AllowlistRejectionScreen");if(t?.privyErrorCode===l.c.USER_LIMIT_REACHED)return console.error(new l.k(t).toString()),T(void 0),h(),void g("UserLimitReachedScreen");if(t?.privyErrorCode===l.c.USER_DOES_NOT_EXIST)return T(void 0),h(),void g("AccountNotFoundScreen");if(t?.privyErrorCode===l.c.ACCOUNT_TRANSFER_REQUIRED&&t.data?.data?.nonce)return T(void 0),h(),u({accountTransfer:{nonce:t.data?.data?.nonce,account:t.data?.data?.subject,telegramAuthResult:S()?.telegramAuthResult,telegramWebAppData:S()?.telegramWebAppData,displayName:t.data?.data?.account?.displayName,linkMethod:"telegram",embeddedWalletAddress:t.data?.data?.otherUser?.embeddedWalletAddress}}),void g("LinkConflictScreen");let{retryable:e,detail:r}=(0,n.m)(t);T({retryable:e,detail:r,message:"Authentication failed"})}}return(0,a.useEffect)(()=>{C()},[]),(0,a.useEffect)(()=>{if(!(t&&e&&k&&d))return;if(x?.legal.requireUsersAcceptTerms&&!d.hasAcceptedTerms){let e=setTimeout(()=>{g("AffirmativeConsentScreen")},o.q);return()=>clearTimeout(e)}if((0,c.s)(d,x.embeddedWallets)){let e=setTimeout(()=>{u({createWallet:{onSuccess:()=>{},onFailure:e=>{console.error(e),j({eventName:"embedded_wallet_creation_failure_logout",payload:{error:e,provider:"telegram",screen:"TelegramAuthScreen"}}),r()},callAuthOnSuccessOnClose:!0}}),g("EmbeddedWalletOnAccountCreateScreen")},o.q);return()=>clearTimeout(e)}y();let i=setTimeout(()=>w({shouldCallAuthOnSuccess:!0,isSuccess:!0}),o.q);return()=>clearTimeout(i)},[t,e,k,d]),(0,i.jsx)(p,{success:k,errorMessage:I,onRetry:I?.retryable?async()=>{try{T(void 0),v?.telegramAuthModalData?.seamlessAuth||await m(void 0,v?.login?.disableSignup),await C()}catch(t){let{retryable:e,detail:r}=(0,n.m)(t);T({retryable:e,detail:r,message:"Authentication failed"})}}:void 0})},isCaptchaRequired:!0,isShownBeforeReady:!0}},56967:(e,r,t)=>{t.d(r,{T:()=>a});var i=t(95155);function a(e){return(0,i.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",...e,children:[(0,i.jsx)("rect",{width:"512",height:"512",rx:"15%",fill:"#37aee2"}),(0,i.jsx)("path",{fill:"#c8daea",d:"M199 404c-11 0-10-4-13-14l-32-105 245-144"}),(0,i.jsx)("path",{fill:"#a9c9dd",d:"M199 404c7 0 11-4 16-8l45-43-56-34"}),(0,i.jsx)("path",{fill:"#f6fbfe",d:"M204 319l135 99c14 9 26 4 30-14l55-258c5-22-9-32-24-25L79 245c-21 8-21 21-4 26l83 26 190-121c9-5 17-3 11 4"})]})}},87584:(e,r,t)=>{t.d(r,{S:()=>j});var i=t(95155),a=t(12115),n=t(20031),o=t(96052),l=t(84241),s=t(95204);let c=n.I4.div`
  /* spacing tokens */
...
`,j=({children:e,...r})=>(0,i.jsx)(c,{children:(0,i.jsx)(d,{...r,children:e})}),S=n.I4.div`
  position: absolute;
  top: 0;
