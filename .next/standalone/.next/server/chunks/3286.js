"use strict";exports.id=3286,exports.ids=[3286],exports.modules={3286:(a,b,c)=>{c.r(b),c.d(b,{LinkPhoneScreen:()=>m,LinkPhoneScreenView:()=>l,default:()=>m});var d=c(21124),e=c(53476),f=c(38301),g=c(90179),h=c(64317),i=c(87230),j=c(23966),k=c(74995);c(18521),c(32571),c(22967);let l=({title:a="Connect your phone",subtitle:b="Add your number to your account",onSubmit:c,isSubmitting:h=!1})=>{let[i,j]=(0,f.useState)(null),l=async()=>{i?.qualifiedPhoneNumber&&await c(i)};return(0,d.jsx)(k.S,{title:a,subtitle:b,icon:e.A,primaryCta:{label:h?"Submitting":"Submit",onClick:l,disabled:!i?.isValid||h},watermark:!0,children:(0,d.jsx)(g.C,{onChange:a=>{j(a)},onSubmit:l,noIncludeSubmitButton:!0,hideRecent:!0})})},m={component:()=>{let{currentScreen:a,data:b,navigate:c,setModalData:e}=(0,j.a)(),g=(0,h.u)(),{initLoginWithSms:k}=(0,i.u)(),[m,n]=(0,f.useState)(!1);return(0,d.jsx)(l,{subtitle:`Add your number to your ${g?.name} account`,onSubmit:async d=>{n(!0);try{await k({phoneNumber:d.qualifiedPhoneNumber,withPrivyUi:!0}),c("AwaitingPasswordlessCodeScreen")}catch(d){e({errorModalData:{error:d,previousScreen:b?.errorModalData?.previousScreen||a||"LinkPhoneScreen"}}),c("ErrorScreen")}finally{n(!1)}},isSubmitting:m})}}},15198:(a,b,c)=>{c.d(b,{S:()=>w});var d=c(21124),e=c(38301),f=c(78858),g=c(99848),h=c(7797),i=c(69456);let j=f.I4.div`
  /* spacing tokens */
