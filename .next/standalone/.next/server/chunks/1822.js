"use strict";exports.id=1822,exports.ids=[1822],exports.modules={1822:(a,b,c)=>{c.r(b),c.d(b,{PasskeyStatusScreen:()=>n,PasskeyStatusScreenView:()=>m,default:()=>n});var d=c(21124),e=c(50386),f=c(38301),g=c(78858),h=c(64317),i=c(87230),j=c(23966),k=c(16747),l=c(74995);c(22967),c(18521),c(32571),c(21398),c(61946);let m=({status:a,passkeySignupFlow:b=!1,error:c,onRetry:f})=>(0,d.jsx)(l.S,{title:(()=>{switch(a){case"loading":return"Waiting for passkey";case"success":return"Success";case"error":return"Something went wrong"}})(),subtitle:(0,d.jsx)(o,{children:(()=>{switch(a){case"loading":return b?"Please follow prompts to register your passkey.":"Please follow prompts to verify your passkey.\nYou will have to sign up with another method first to register a passkey for your account.";case"success":return"You've successfully logged in with your passkey.";case"error":if(c instanceof i.g){if(c.privyErrorCode===i.c.CANNOT_LINK_MORE_OF_TYPE)return"Cannot link more passkeys to account.";if(c.privyErrorCode===i.c.PASSKEY_NOT_ALLOWED)return"Passkey request timed out or rejected by user.\nYou will have to sign up with another method first to register a passkey for your account."}return"An unknown error occurred.\nYou will have to sign up with another method first to register a passkey for your account."}})()}),icon:e.A,iconVariant:"loading",iconLoadingStatus:{success:"success"===a,fail:"error"===a},primaryCta:"error"===a&&f?{label:"Retry",onClick:f}:"success"===a?{label:"Continue",disabled:!0}:void 0,watermark:!0}),n={component:()=>{let{data:a,setModalData:b,navigate:c}=(0,j.a)(),e=(0,h.u)(),{loginWithPasskey:g,signupWithPasskey:l,closePrivyModal:n,createAnalyticsEvent:o}=(0,i.u)(),{user:p,logout:q,ready:r,authenticated:s}=(0,j.u)(),{passkeySignupFlow:t}=a?.passkeyAuthModalData??{},u=h.q-500,[v,w]=(0,f.useState)("loading"),[x,y]=(0,f.useState)(null),z=(0,f.useRef)([]),A=a=>{z.current=[a,...z.current]};(0,f.useEffect)(()=>()=>{z.current.forEach(a=>clearTimeout(a)),z.current=[]},[]);let B=async()=>{w("loading");try{t?await l():await g(),w("success")}catch(a){if(a?.privyErrorCode===i.c.USER_DOES_NOT_EXIST)return void c("AccountNotFoundScreen");if(a?.privyErrorCode===i.c.ALLOWLIST_REJECTED)return void c("AllowlistRejectionScreen");if(a?.privyErrorCode===i.c.USER_LIMIT_REACHED)return void c("UserLimitReachedScreen");y(a),w("error")}};return(0,f.useEffect)(()=>{if(r&&s&&"success"===v&&p){if(e?.legal.requireUsersAcceptTerms&&!p.hasAcceptedTerms)return void A(setTimeout(()=>{c("AffirmativeConsentScreen")},u));if(!(0,k.s)(p,e?.embeddedWallets))return void A(setTimeout(()=>{n({shouldCallAuthOnSuccess:!0,isSuccess:!0})},h.q));A(setTimeout(()=>{b({createWallet:{onSuccess:()=>{},onFailure:a=>{console.error(a),o({eventName:"embedded_wallet_creation_failure_logout",payload:{error:a,screen:"PasskeyStatusScreen"}}),q()},callAuthOnSuccessOnClose:!0}}),c("EmbeddedWalletOnAccountCreateScreen")},u))}},[r,s,p,v]),(0,f.useEffect)(()=>{B()},[]),(0,d.jsx)(m,{status:v,passkeySignupFlow:t,error:x,onRetry:B})}},o=g.I4.span`
