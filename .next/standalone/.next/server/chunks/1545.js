...
`},21728:(a,b,c)=>{c.d(b,{A:()=>d});let d=(0,c(6101).A)("circle-x",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]])},31545:(a,b,c)=>{c.r(b),c.d(b,{CaptchaScreen:()=>l,CaptchaScreenView:()=>k,default:()=>l});var d=c(21124),e=c(32863),f=c(21728),g=c(38301),h=c(95761),i=c(23966),j=c(74995);c(18521),c(22967),c(32571),c(21398),c(61946);let k=({status:a,title:b,description:c,userIntentRequired:h,retriesRemaining:i,hasSelectedCta:k,onContinue:l,onRetry:m})=>{let n=(0,g.useMemo)(()=>{switch(a){case"loading":default:return;case"success":return h?{label:k?"Continuing...":"Continue",onClick:l,disabled:k,loading:k}:void 0;case"error":return i>0?{label:"Retry",onClick:m}:void 0}},[a,k,l,m]),o=(0,g.useMemo)(()=>({loading:"loading",ready:"subtle",disabled:"subtle",success:"success",error:"error"})[a]||"loading",[a]);return(0,d.jsx)(j.S,{icon:"loading"===a||"ready"===a?void 0:"success"===a?e.A:f.A,iconVariant:o,title:b,subtitle:c,primaryCta:n,watermark:!0})},l={component:()=>{let{lastScreen:a,data:b,navigate:c,setModalData:e}=(0,i.a)(),{status:f,token:j,waitForResult:l,reset:m,execute:n}=(0,h.a)(),o=(0,g.useRef)([]),p=a=>{o.current=[a,...o.current]},[q,r]=(0,g.useState)(!0);(0,g.useEffect)(()=>(p(setTimeout(r,1e3,!1)),()=>{o.current.forEach(a=>clearTimeout(a)),o.current=[]}),[]);let[s,t]=(0,g.useState)(""),[u,v]=(0,g.useState)("Checking that you are a human..."),[w,x]=(0,g.useState)(!1),[y,z]=(0,g.useState)(3),A=b?.captchaModalData,B=async b=>{try{await A?.callback(b),A?.onSuccessNavigateTo&&c(A?.onSuccessNavigateTo,!1)}catch(b){if(b instanceof h.C)return;e({errorModalData:{error:b,previousScreen:a||"LandingScreen"}}),c(A?.onErrorNavigateTo||"ErrorScreen",!1)}};return(0,g.useEffect)(()=>{"success"===f?p(setTimeout(async()=>{let a=await l();!a||A?.userIntentRequired||B(a)},1e3)):"ready"===f&&p(setTimeout(()=>{"ready"===f&&n()},500))},[f]),(0,g.useEffect)(()=>{if(!q)switch(f){case"success":t("Success!"),v("CAPTCHA passed successfully."),A?.userIntentRequired||setTimeout(()=>{x(!0),B(j)},2e3);break;case"loading":t(""),v("Checking that you are a human...");break;case"error":t("Something went wrong"),v(y<=0?"If you use an adblocker or VPN, try disabling and re-attempting.":"You did not pass CAPTCHA. Please try again.")}},[f,q,w]),(0,d.jsx)(k,{status:f,title:s,description:u,userIntentRequired:A?.userIntentRequired,retriesRemaining:y,hasSelectedCta:w,onContinue:()=>{x(!0),B(j)},onRetry:async()=>{if(y<=0)return;z(a=>a-1),m(),n();let a=await l();!a||A?.userIntentRequired||B(a)}})}}},32863:(a,b,c)=>{c.d(b,{A:()=>d});let d=(0,c(6101).A)("circle-check-big",[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]])},69456:(a,b,c)=>{c.d(b,{N:()=>f});var d=c(21124),e=c(78858);let f=({size:a,centerIcon:b})=>(0,d.jsx)(g,{$size:a,children:(0,d.jsxs)(h,{children:[(0,d.jsx)(j,{}),(0,d.jsx)(k,{}),b?(0,d.jsx)(i,{children:b}):null]})}),g=e.I4.div`
