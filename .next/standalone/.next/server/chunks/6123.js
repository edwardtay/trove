...
`},32863:(a,b,c)=>{c.d(b,{A:()=>d});let d=(0,c(6101).A)("circle-check-big",[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]])},66123:(a,b,c)=>{c.r(b),c.d(b,{DelegatedActionsRevokeScreen:()=>n,DelegatedActionsRevokeScreenView:()=>m,default:()=>n});var d=c(21124),e=c(85906),f=c(32863);let g=(0,c(6101).A)("ban",[["path",{d:"M4.929 4.929 19.07 19.071",key:"196cmz"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]]);var h=c(38301),i=c(64317),j=c(87230),k=c(23966),l=c(74995);c(22967),c(18521),c(32571);let m=({appName:a,success:b,error:c,onRevoke:h,onDeny:i,onClose:j})=>(0,d.jsx)(l.S,b||c?{title:c?"Something went wrong":"Success!",subtitle:c?"Please try again.":"You've successfully revoked permissions.",icon:c?e.A:f.A,iconVariant:c?"error":"success",onBack:j,watermark:!0}:{title:"Revoke offline access to wallet",subtitle:`By confirming, ${a} will no longer be able to use this wallet on your behalf when you are not online.`,icon:g,primaryCta:{label:"Confirm",onClick:h},secondaryCta:{label:"Deny",onClick:i},onBack:j,watermark:!0}),n={component:()=>{let{data:a}=(0,k.a)(),b=(0,i.u)(),{closePrivyModal:c}=(0,j.u)(),[e,f]=(0,h.useState)(!1),[g,l]=(0,h.useState)(),{onRevoke:n,onSuccess:o,onError:p}=a.delegatedActions.revoke,q=async()=>{e?o():p(g??new j.b("User declined revoking access to their delegated wallet.")),c({shouldCallAuthOnSuccess:!1})};return(0,h.useEffect)(()=>{if(!e&&!g)return;let a=setTimeout(q,i.r);return()=>clearTimeout(a)},[e,g]),(0,d.jsx)(m,{appName:b.name,success:e,error:g,onRevoke:async()=>{try{await n(),f(!0)}catch(a){l(a)}},onDeny:()=>{q()},onClose:q})}}},69456:(a,b,c)=>{c.d(b,{N:()=>f});var d=c(21124),e=c(78858);let f=({size:a,centerIcon:b})=>(0,d.jsx)(g,{$size:a,children:(0,d.jsxs)(h,{children:[(0,d.jsx)(j,{}),(0,d.jsx)(k,{}),b?(0,d.jsx)(i,{children:b}):null]})}),g=e.I4.div`
