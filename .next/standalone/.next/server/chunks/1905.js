...
`},21728:(a,b,c)=>{c.d(b,{A:()=>d});let d=(0,c(6101).A)("circle-x",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]])},21905:(a,b,c)=>{c.r(b),c.d(b,{EmbeddedWalletConnectingScreen:()=>l,EmbeddedWalletConnectingView:()=>k,default:()=>l});var d=c(21124),e=c(21728),f=c(38301),g=c(95761),h=c(87230),i=c(23966),j=c(74995);c(18521),c(22967),c(32571),c(21398),c(61946);let k=({connectionFailed:a,onClose:b})=>(0,d.jsx)(j.S,a?{title:"Something went wrong",subtitle:"We're on it. Please try again later.",icon:e.A,iconVariant:"error",primaryCta:{label:"Close",onClick:b},watermark:!0}:{title:"Connecting to your wallet",subtitle:"Please wait...",iconVariant:"loading",showClose:!0,onClose:b,watermark:!1}),l={component:()=>{let{authenticated:a,user:b}=(0,i.u)(),{client:c,closePrivyModal:e,createAnalyticsEvent:j,walletProxy:l}=(0,h.u)(),{navigate:m,data:n,setModalData:o,onUserCloseViaDialogOrKeybindRef:p}=(0,i.a)(),q=(0,f.useMemo)(()=>Date.now(),[]),[r,s]=(0,f.useState)(!1),{onCompleteNavigateTo:t,onFailure:u,shouldForceMFA:v,entropyId:w,entropyIdVerifier:x,recoveryMethod:y,connectingWalletAddress:z,isUnifiedWallet:A=!1}=n?.connectWallet??{},B=a=>{r||(s(!0),u("string"==typeof a?Error(a):a))};return(0,f.useEffect)(()=>{let b;return a?l?((async()=>{let a=await c.getAccessToken();if(!a)return B("User must be authenticated and have a Privy wallet before it can be connected");try{if(!A){if(!w||!x)return B("For on-device first-class chain wallets, entropyId and entropyIdVerifier are required");await l.connect({accessToken:a,entropyId:w,entropyIdVerifier:x})}v&&await l.verifyMfa({accessToken:a});let c=(Date.now()-q)/1e3;"EmbeddedWalletKeyExportScreen"===t&&c<1?b=setTimeout(()=>{m(t,!1)},1e3*(1-c)):m(t,!1)}catch(a){if((0,g.e)(a)&&"privy"===y){let a=await c.getAccessToken();if(!a)return B("User must be authenticated and have a Privy wallet before it can be recovered");try{j({eventName:"embedded_wallet_pinless_recovery_started",payload:{walletAddress:z}});let b=await l?.recover({accessToken:a,entropyId:w,entropyIdVerifier:x});b?.entropyId||B(Error("Unable to recover wallet")),t?m(t):e({shouldCallAuthOnSuccess:!1}),j({eventName:"embedded_wallet_recovery_completed",payload:{walletAddress:z}}),m(t)}catch(a){B("An error has occurred, please try again.")}}else(0,g.e)(a)&&"privy"!==y&&"privy-v2"!==y?(o({...n,recoverWallet:{entropyId:w,entropyIdVerifier:x,onCompleteNavigateTo:t,onFailure:u},recoveryOAuthStatus:{provider:y,action:"recover",isInAccountCreateFlow:!1,shouldCreateEth:!1,shouldCreateSol:!1}}),m((0,g.c)(y))):B(a)}})(),()=>clearTimeout(b)):void 0:B("User must be authenticated and have a Privy wallet before it can be connected")},[a,b,l]),p.current=()=>{B("User exited before wallet could be connected"),e({shouldCallAuthOnSuccess:!1})},(0,d.jsx)(k,{connectionFailed:r,onClose:()=>e({shouldCallAuthOnSuccess:!1})})}}},69456:(a,b,c)=>{c.d(b,{N:()=>f});var d=c(21124),e=c(78858);let f=({size:a,centerIcon:b})=>(0,d.jsx)(g,{$size:a,children:(0,d.jsxs)(h,{children:[(0,d.jsx)(j,{}),(0,d.jsx)(k,{}),b?(0,d.jsx)(i,{children:b}):null]})}),g=e.I4.div`
