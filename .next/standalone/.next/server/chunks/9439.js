...
`},39439:(a,b,c)=>{c.r(b),c.d(b,{AccountNotFoundScreen:()=>k,AccountNotFoundScreenView:()=>j,default:()=>k});var d=c(21124);let e=(0,c(6101).A)("circle-question-mark",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);var f=c(64317),g=c(87230),h=c(23966),i=c(74995);c(38301),c(22967),c(18521),c(32571);let j=({title:a="Account not found",subtitle:b,appName:c="this app",ctaText:f="Try logging in again",onRetry:g})=>(0,d.jsx)(i.S,{title:a,subtitle:b||`Please try logging in again or go to ${c} to create an account.`,icon:e,iconVariant:"warning",primaryCta:{label:f,onClick:g},watermark:!0}),k={component:()=>{let{navigate:a,setModalData:b,data:c}=(0,h.a)(),e=(0,f.u)(),{getAuthMeta:i,client:k}=(0,g.u)();return(0,d.jsx)(j,{appName:e?.name,onRetry:()=>{let d=i();b({...c,login:{...c?.login,...d?.disableSignup?{disableSignup:!0}:{}}}),k?.authFlow&&(k.authFlow=void 0),a("LandingScreen")}})}}},69456:(a,b,c)=>{c.d(b,{N:()=>f});var d=c(21124),e=c(78858);let f=({size:a,centerIcon:b})=>(0,d.jsx)(g,{$size:a,children:(0,d.jsxs)(h,{children:[(0,d.jsx)(j,{}),(0,d.jsx)(k,{}),b?(0,d.jsx)(i,{children:b}):null]})}),g=e.I4.div`
