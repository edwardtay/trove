...
`},72460:(a,b,c)=>{c.r(b),c.d(b,{AffirmativeConsentScreen:()=>n,AffirmativeConsentScreenView:()=>o,default:()=>n});var d=c(21124);let e=(0,c(6101).A)("file-check",[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"m9 15 2 2 4-4",key:"1grp1n"}]]);var f=c(5179);c(38301);var g=c(78858),h=c(7797),i=c(64317),j=c(87230),k=c(23966),l=c(16747),m=c(74995);c(18521),c(32571),c(22967),c(21398),c(61946);let n={component:()=>{let{user:a,logout:b}=(0,k.u)(),{onUserCloseViaDialogOrKeybindRef:c,setModalData:e,navigate:f}=(0,k.a)(),g=(0,i.u)(),{acceptTerms:h,closePrivyModal:m,createAnalyticsEvent:n}=(0,j.u)(),p=a=>{a?.preventDefault(),m({shouldCallAuthOnSuccess:!1}),b()};return c.current=p,(0,d.jsx)(o,{termsAndConditionsUrl:g?.legal.termsAndConditionsUrl,privacyPolicyUrl:g?.legal.privacyPolicyUrl,onAccept:async c=>{c?.preventDefault(),await h(),a&&(0,l.s)(a,g.embeddedWallets)?(e({createWallet:{onSuccess:()=>{},onFailure:a=>{console.error(a),n({eventName:"embedded_wallet_creation_failure_logout",payload:{error:a,screen:"AffirmativeConsentScreen"}}),b()},callAuthOnSuccessOnClose:!0}}),f("EmbeddedWalletOnAccountCreateScreen")):m()},onDecline:p})}},o=({termsAndConditionsUrl:a,privacyPolicyUrl:b,onAccept:c,onDecline:g,title:i="One last step",subtitle:j="By signing up, you agree to our terms and privacy policy."})=>(0,d.jsx)(m.S,{title:i,subtitle:j,icon:e,primaryCta:{label:"Accept",onClick:c},secondaryCta:{label:"No thanks",onClick:g},watermark:!0,children:(a||b)&&(0,d.jsxs)(p,{children:[a&&(0,d.jsxs)(h.a,{variant:"muted",href:a,target:"_blank",size:"lg",style:{justifyContent:"space-between"},as:"a",children:["View Terms",(0,d.jsx)(f.A,{width:16,height:16,strokeWidth:2.25})]}),b&&(0,d.jsxs)(h.a,{variant:"muted",href:b,target:"_blank",size:"lg",style:{justifyContent:"space-between"},as:"a",children:["View Privacy Policy",(0,d.jsx)(f.A,{width:16,height:16,strokeWidth:2.25})]})]})}),p=g.I4.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
