...
`},34022:(a,b,c)=>{c.d(b,{A:()=>d});let d=(0,c(6101).A)("lock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]])},68674:(a,b,c)=>{c.r(b),c.d(b,{AllowlistRejectionScreen:()=>j,AllowlistRejectionScreenView:()=>i,default:()=>j});var d=c(21124),e=c(34022);c(38301);var f=c(64317),g=c(23966),h=c(74995);c(22967),c(18521),c(32571);let i=({title:a="You don't have access to this app",subtitle:b="Have you been invited?",ctaText:c="Try another account",ctaLink:f,onCtaClick:g})=>(0,d.jsx)(h.S,{title:a,subtitle:b,icon:e.A,iconVariant:"warning",primaryCta:{label:c,onClick:()=>{f?window.open(f,"_blank"):g?.()}},watermark:!0}),j={component:()=>{let{navigate:a}=(0,g.a)(),b=(0,f.u)(),c=b?.allowlistConfig.errorTitle||"You don't have access to this app",e=b?.allowlistConfig.errorDetail||"Have you been invited?",h=b?.allowlistConfig.errorCtaText||"Try another account",j=b?.allowlistConfig.errorCtaLink;return(0,d.jsx)(i,{title:c,subtitle:e,ctaText:h,ctaLink:j??void 0,onCtaClick:()=>{a("LandingScreen")}})}}},69456:(a,b,c)=>{c.d(b,{N:()=>f});var d=c(21124),e=c(78858);let f=({size:a,centerIcon:b})=>(0,d.jsx)(g,{$size:a,children:(0,d.jsxs)(h,{children:[(0,d.jsx)(j,{}),(0,d.jsx)(k,{}),b?(0,d.jsx)(i,{children:b}):null]})}),g=e.I4.div`
