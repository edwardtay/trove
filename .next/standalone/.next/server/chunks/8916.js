...
`},74995:(a,b,c)=>{c.d(b,{S:()=>g});var d=c(21124),e=c(7797),f=c(15198);let g=({primaryCta:a,secondaryCta:b,helpText:c,footerText:g,watermark:h=!0,children:i,...j})=>{let k=a||b?(0,d.jsxs)(d.Fragment,{children:[a&&(()=>{let{label:b,...c}=a,f=c.variant||"primary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:b})})(),b&&(()=>{let{label:a,...c}=b,f=c.variant||"secondary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:a})})()]}):null;return(0,d.jsxs)(f.S,{id:j.id,className:j.className,children:[(0,d.jsx)(f.S.Header,{...j}),i?(0,d.jsx)(f.S.Body,{children:i}):null,c||k||h?(0,d.jsxs)(f.S.Footer,{children:[c?(0,d.jsx)(f.S.HelpText,{children:c}):null,k?(0,d.jsx)(f.S.Actions,{children:k}):null,h?(0,d.jsx)(f.S.Watermark,{}):null]}):null,g?(0,d.jsx)(f.S.FooterText,{children:g}):null]})}},88916:(a,b,c)=>{c.r(b),c.d(b,{EmbeddedWalletOnAccountCreateScreen:()=>o,EmbeddedWalletOnAccountCreateView:()=>n,default:()=>o});var d=c(21124),e=c(21728),f=c(38301);async function g(a,b){let c=`${a}-auto-${"ethereum"===b?"eth":"sol"}`,d=(new TextEncoder).encode(c);return Array.from(new Uint8Array(await crypto.subtle.digest("SHA-256",d))).map(a=>a.toString(16).padStart(2,"0")).join("")}var h=c(64317),i=c(95761),j=c(87230),k=c(23966),l=c(98403),m=c(74995);c(22967),c(18521),c(32571),c(21398),c(61946);let n=({errorMessage:a,onClose:b})=>(0,d.jsx)(m.S,a?{title:"Something went wrong",subtitle:a,icon:e.A,iconVariant:"error",primaryCta:{label:"Close",onClick:b},watermark:!0}:{title:"Creating your wallet",subtitle:"Please wait...",iconVariant:"loading",watermark:!1}),o={component:()=>{let{setModalData:a,navigate:b,data:c,onUserCloseViaDialogOrKeybindRef:e}=(0,k.a)(),m=(0,h.u)(),[o,p]=(0,f.useState)(""),{embeddedWallets:q}=(0,h.u)(),{authenticated:r,user:s}=(0,k.u)(),{closePrivyModal:t,walletProxy:u,client:v}=(0,j.u)(),{onSuccess:w,onFailure:x,callAuthOnSuccessOnClose:y,shouldCreateEth:z,shouldCreateSol:A}=c.createWallet,B=(0,l.u)(),C=s?B(i.A)?.shouldCreateWallet({user:s}):void 0,D=!!s&&(0,i.s)(s,m.embeddedWallets.ethereum.createOnLogin,C),E=!!s&&(0,i.k)(s,m.embeddedWallets.solana.createOnLogin,C),F="legacy-embedded-wallets-only"===m.embeddedWallets.mode&&!0===m?.embeddedWallets.requireUserOwnedRecoveryOnCreate,[G,H]=(0,f.useState)(null),{create:I}=(0,i.o)(),J=z??D,K=A??E,L=new i.R(async()=>{let a=await v.getAccessToken();if(s&&a&&u)try{let a,c=await g(s.id,"ethereum"),d=await g(s.id,"solana");if(J&&K)a=await I({chainType:"ethereum",walletIndex:0,latestUser:s,idempotencyKey:c}),a=await I({chainType:"solana",walletIndex:0,latestUser:a.user,idempotencyKey:d});else if(K)a=await I({chainType:"solana",walletIndex:0,latestUser:s,idempotencyKey:d});else{if(!J)return void t({shouldCallAuthOnSuccess:y});a=await I({chainType:"ethereum",walletIndex:0,latestUser:s,idempotencyKey:c})}H(a),b("EmbeddedWalletCreatedScreen")}catch(a){p(a.message)}});return(0,f.useEffect)(()=>r&&s?F?(a({...c,createWallet:{...c.createWallet,shouldCreateEth:J,shouldCreateSol:K},recoverySelection:{...c?.recoverySelection,isInAccountCreateFlow:!0,shouldCreateEth:J,shouldCreateSol:K}}),b((0,i.D)({walletAction:"create",showAutomaticRecovery:!1,availableRecoveryMethods:q.userOwnedRecoveryOptions,legacySetWalletPasswordFlow:!1,isResettingPassword:!1}))):void L.execute():(b("LandingScreen"),void x(Error("User must be authenticated before creating a Privy wallet"))),[F,r]),e.current=()=>null,(0,d.jsx)(n,{errorMessage:o||void 0,onClose:()=>{G?(w(G),t({shouldCallAuthOnSuccess:y})):(x(new j.m("User wallet creation failed")),t({shouldCallAuthOnSuccess:!1}))}})}}}};