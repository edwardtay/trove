...
`},74995:(a,b,c)=>{c.d(b,{S:()=>g});var d=c(21124),e=c(7797),f=c(15198);let g=({primaryCta:a,secondaryCta:b,helpText:c,footerText:g,watermark:h=!0,children:i,...j})=>{let k=a||b?(0,d.jsxs)(d.Fragment,{children:[a&&(()=>{let{label:b,...c}=a,f=c.variant||"primary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:b})})(),b&&(()=>{let{label:a,...c}=b,f=c.variant||"secondary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:a})})()]}):null;return(0,d.jsxs)(f.S,{id:j.id,className:j.className,children:[(0,d.jsx)(f.S.Header,{...j}),i?(0,d.jsx)(f.S.Body,{children:i}):null,c||k||h?(0,d.jsxs)(f.S.Footer,{children:[c?(0,d.jsx)(f.S.HelpText,{children:c}):null,k?(0,d.jsx)(f.S.Actions,{children:k}):null,h?(0,d.jsx)(f.S.Watermark,{}):null]}):null,g?(0,d.jsx)(f.S.FooterText,{children:g}):null]})}},95758:(a,b,c)=>{c.r(b),c.d(b,{SignRequestScreen:()=>w,SignRequestView:()=>v,default:()=>w});var d=c(21124),e=c(51661);let f=(0,c(6101).A)("square-pen",[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z",key:"ohrbg2"}]]);var g=c(38301),h=c(78858),i=c(97917),j=c(48072),k=c(53285),l=c(25383),m=c(27829),n=c(98458),o=c(44110),p=c(64317),q=c(87230),r=c(23966),s=c(74995);c(18521),c(22967),c(32571);let t=h.I4.img`
  && {
...
`,A=(0,h.I4)(n.M)`
  margin-top: 0;
`},98458:(a,b,c)=>{c.d(b,{D:()=>i,M:()=>g});var d=c(21124),e=c(78858);let f=({data:a})=>{let b=a=>"object"==typeof a&&null!==a?(0,d.jsx)(h,{children:Object.entries(a).map(([a,c])=>(0,d.jsxs)("li",{children:[(0,d.jsxs)("strong",{children:[a,":"]})," ",b(c)]},a))}):(0,d.jsx)("span",{children:String(a)});return(0,d.jsx)("div",{children:b(a)})},g=e.I4.div`
  margin-top: 1.5rem;
...
`,i=({data:a,className:b})=>(0,d.jsx)(g,{className:b,children:(0,d.jsx)(f,{data:a})})}};