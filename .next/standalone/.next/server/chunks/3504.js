"use strict";exports.id=3504,exports.ids=[3504],exports.modules={15198:(a,b,c)=>{c.d(b,{S:()=>w});var d=c(21124),e=c(38301),f=c(78858),g=c(99848),h=c(7797),i=c(69456);let j=f.I4.div`
  /* spacing tokens */
...
`},73504:(a,b,c)=>{c.r(b),c.d(b,{WalletInterstitialScreen:()=>i,WalletInterstitialScreenView:()=>h,default:()=>i});var d=c(21124),e=c(38301),f=c(23966),g=c(74995);c(22967),c(18521),c(32571);let h=({title:a,subtitle:b,buttonText:c,buttonHref:e,isLoading:f=!1,helpText:h,onButtonClick:i})=>(0,d.jsx)(g.S,{title:a,subtitle:b,primaryCta:{label:c,onClick:()=>{e&&window.open(e,"_self"),i?.()},disabled:f},helpText:h,watermark:!0}),i={component:()=>{let{ready:a}=(0,f.u)(),{data:b}=(0,f.a)(),[c,g]=(0,e.useState)(!1);if(!b?.installWalletModalData)throw Error("Wallet data is missing");let{walletConfig:i,connectOnly:j,chainType:k}=b.installWalletModalData,l=i.getMobileRedirect({useUniversalLink:!c,isSolana:"solana"===k,connectOnly:j}),m=i.name.replace(/ wallet/gi,""),n={title:`Redirecting to ${m} Mobile Wallet`,description:`We'll take you to the ${m} Mobile Wallet app to continue your login experience.`,footnote:""};return a&&(n.description=`For the best experience, we'll automatically log you into the ${m} Mobile Wallet in-app browser.`,n.footnote="You can always return here to login via other methods."),c&&(n.title="Still here?",n.description=`You may need to install the ${i.name} mobile app.`,n.footnote=`Once you're done, you can connect with ${i.name} wallet to complete the login.`),(0,d.jsx)(h,{title:n.title,subtitle:n.description,buttonText:c?"Go to App Store":"Continue",buttonHref:l,isLoading:a&&!l,helpText:n.footnote||void 0,onButtonClick:()=>{setTimeout(()=>g(!0),1e3)}})}}},74995:(a,b,c)=>{c.d(b,{S:()=>g});var d=c(21124),e=c(7797),f=c(15198);let g=({primaryCta:a,secondaryCta:b,helpText:c,footerText:g,watermark:h=!0,children:i,...j})=>{let k=a||b?(0,d.jsxs)(d.Fragment,{children:[a&&(()=>{let{label:b,...c}=a,f=c.variant||"primary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:b})})(),b&&(()=>{let{label:a,...c}=b,f=c.variant||"secondary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:a})})()]}):null;return(0,d.jsxs)(f.S,{id:j.id,className:j.className,children:[(0,d.jsx)(f.S.Header,{...j}),i?(0,d.jsx)(f.S.Body,{children:i}):null,c||k||h?(0,d.jsxs)(f.S.Footer,{children:[c?(0,d.jsx)(f.S.HelpText,{children:c}):null,k?(0,d.jsx)(f.S.Actions,{children:k}):null,h?(0,d.jsx)(f.S.Watermark,{}):null]}):null,g?(0,d.jsx)(f.S.FooterText,{children:g}):null]})}}};