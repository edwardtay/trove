...
`},72497:(a,b,c)=>{c.r(b),c.d(b,{EmbeddedWalletPasswordUpdateSplashScreen:()=>j,EmbeddedWalletPasswordUpdateSplashView:()=>i,default:()=>j});var d=c(21124),e=c(34022),f=c(87230),g=c(23966),h=c(74995);c(38301),c(22967),c(18521),c(32571);let i=({onClose:a,onProceed:b})=>(0,d.jsx)(h.S,{title:"Secure Your Account",subtitle:(0,d.jsxs)(d.Fragment,{children:["Please set a password to secure your account.",(0,d.jsx)("br",{}),"Losing access to this password and this device will make your account inaccessible."]}),icon:e.A,primaryCta:{label:"Add password",onClick:b},onClose:a,watermark:!0}),j={component:()=>{let{closePrivyModal:a}=(0,f.u)(),{data:b,navigate:c,onUserCloseViaDialogOrKeybindRef:e}=(0,g.a)(),{onFailure:h}=b.setWalletPassword,j=()=>{h(new f.m("Exited before password was added to wallet")),a({shouldCallAuthOnSuccess:!1})};return e.current=j,(0,d.jsx)(i,{onClose:j,onProceed:()=>{c("EmbeddedWalletPasswordUpdateScreen")}})}}},74995:(a,b,c)=>{c.d(b,{S:()=>g});var d=c(21124),e=c(7797),f=c(15198);let g=({primaryCta:a,secondaryCta:b,helpText:c,footerText:g,watermark:h=!0,children:i,...j})=>{let k=a||b?(0,d.jsxs)(d.Fragment,{children:[a&&(()=>{let{label:b,...c}=a,f=c.variant||"primary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:b})})(),b&&(()=>{let{label:a,...c}=b,f=c.variant||"secondary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:a})})()]}):null;return(0,d.jsxs)(f.S,{id:j.id,className:j.className,children:[(0,d.jsx)(f.S.Header,{...j}),i?(0,d.jsx)(f.S.Body,{children:i}):null,c||k||h?(0,d.jsxs)(f.S.Footer,{children:[c?(0,d.jsx)(f.S.HelpText,{children:c}):null,k?(0,d.jsx)(f.S.Actions,{children:k}):null,h?(0,d.jsx)(f.S.Watermark,{}):null]}):null,g?(0,d.jsx)(f.S.FooterText,{children:g}):null]})}}};