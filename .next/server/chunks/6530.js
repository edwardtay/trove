...
`},74995:(a,b,c)=>{c.d(b,{S:()=>g});var d=c(21124),e=c(7797),f=c(15198);let g=({primaryCta:a,secondaryCta:b,helpText:c,footerText:g,watermark:h=!0,children:i,...j})=>{let k=a||b?(0,d.jsxs)(d.Fragment,{children:[a&&(()=>{let{label:b,...c}=a,f=c.variant||"primary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:b})})(),b&&(()=>{let{label:a,...c}=b,f=c.variant||"secondary";return(0,d.jsx)(e.a,{...c,variant:f,style:{width:"100%",...c.style},children:a})})()]}):null;return(0,d.jsxs)(f.S,{id:j.id,className:j.className,children:[(0,d.jsx)(f.S.Header,{...j}),i?(0,d.jsx)(f.S.Body,{children:i}):null,c||k||h?(0,d.jsxs)(f.S.Footer,{children:[c?(0,d.jsx)(f.S.HelpText,{children:c}):null,k?(0,d.jsx)(f.S.Actions,{children:k}):null,h?(0,d.jsx)(f.S.Watermark,{}):null]}):null,g?(0,d.jsx)(f.S.FooterText,{children:g}):null]})}},86530:(a,b,c)=>{c.r(b),c.d(b,{EmbeddedWalletCreatedScreen:()=>l,EmbeddedWalletCreatedScreenView:()=>k,default:()=>l});var d=c(21124),e=c(32863),f=c(38301),g=c(23966),h=c(64317),i=c(87230),j=c(74995);c(22967),c(18521),c(32571);let k=({title:a,description:b,onClose:c})=>(0,d.jsx)(j.S,{title:a,subtitle:b,icon:e.A,iconVariant:"success",watermark:!0,onBack:c}),l={component:()=>{let{user:a}=(0,g.u)(),{closePrivyModal:b,isNewUserThisSession:c,updateWallets:e}=(0,i.u)(),{data:j,onUserCloseViaDialogOrKeybindRef:l}=(0,g.a)(),m=(0,h.u)(),{onSuccess:n,onFailure:o,callAuthOnSuccessOnClose:p}=j.createWallet,q=()=>{let c=(0,g.d)(a)??(0,g.f)(a);a&&c?(e(),n({user:a,account:c})):o(Error("Failed to create wallet")),b({shouldCallAuthOnSuccess:p})};(0,f.useEffect)(()=>{let a=setTimeout(q,h.r);return()=>clearTimeout(a)},[]),l.current=q;let r=c&&!((a?.linkedAccounts?.length??0)>1);return(0,d.jsx)(k,{title:r?"Welcome"+(m?.name?` to ${m?.name}`:""):"All set!",description:r?"You've successfully created an account.":"Your account is secured.",onClose:q})}}}};