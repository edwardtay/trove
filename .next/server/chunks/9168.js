...
`},15316:(a,b,c)=>{c.d(b,{O:()=>g});var d=c(21124),e=c(38301),f=c(78858);let g=a=>{let[b,c]=(0,e.useState)(!1);return(0,d.jsx)(h,{color:a.color,href:a.url,target:"_blank",rel:"noreferrer noopener",onClick:()=>{c(!0),setTimeout(()=>c(!1),1500)},justOpened:b,children:a.text})},h=f.I4.a`
  display: flex;
  align-items: center;
  gap: 6px;
...
`},24406:(a,b,c)=>{c.r(b),c.d(b,{FarcasterSignerStatusScreen:()=>y,FarcasterSignerStatusView:()=>r,default:()=>y});var d=c(21124),e=c(38301),f=c(32571),g=c(78858),h=c(25383),i=c(99848),j=c(15316),k=c(41204),l=c(64317),m=c(87230),n=c(23966),o=c(74995),p=c(2281);c(18521),c(34351),c(22967);let q="#8a63d2",r=({appName:a,loading:b,success:c,errorMessage:e,connectUri:g,onBack:l,onClose:m,onOpenFarcaster:n})=>(0,d.jsx)(o.S,f.Fr||b?f.un?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${a} to add casts, likes, follows, and more on your behalf.`,icon:p.F,iconVariant:"loading",iconLoadingStatus:{success:c,fail:!!e},primaryCta:g&&n?{label:"Open Farcaster app",onClick:n}:void 0,onBack:l,onClose:m,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:p.F,iconVariant:"loading",iconLoadingStatus:{success:c,fail:!!e},onBack:l,onClose:m,watermark:!0,children:g&&f.Fr&&(0,d.jsx)(s,{children:(0,d.jsx)(j.O,{text:"Take me to Farcaster",url:g,color:q})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${a} to add casts, likes, follows, and more on your behalf.`,onBack:l,onClose:m,watermark:!0,children:(0,d.jsxs)(t,{children:[(0,d.jsx)(u,{children:g?(0,d.jsx)(k.Q,{url:g,size:275,squareLogoElement:p.F}):(0,d.jsx)(x,{children:(0,d.jsx)(i.L,{})})}),(0,d.jsxs)(v,{children:[(0,d.jsx)(w,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),g&&(0,d.jsx)(h.C,{text:g,itemName:"link",color:q})]})]})}),s=g.I4.div`
  margin-top: 24px;
`,t=g.I4.div`
  display: flex;
  flex-direction: column;
