...
`,f=d.I4.div`
  ${e}
`},32863:(a,b,c)=>{c.d(b,{A:()=>d});let d=(0,c(6101).A)("circle-check-big",[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]])},36860:(a,b,c)=>{c.r(b),c.d(b,{DelegatedActionsConsentScreen:()=>o,DelegatedActionsConsentScreenView:()=>n,default:()=>o});var d=c(21124),e=c(85906),f=c(32863);let g=(0,c(6101).A)("cloud-upload",[["path",{d:"M12 13v8",key:"1l5pq0"}],["path",{d:"M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242",key:"1pljnt"}],["path",{d:"m8 17 4-4 4 4",key:"1quai1"}]]);var h=c(38301),i=c(24402),j=c(64317),k=c(87230),l=c(23966),m=c(74995);c(18521),c(32571),c(22967);let n=({appName:a,address:b,success:c,error:h,onAccept:j,onDecline:k,onClose:l})=>(0,d.jsx)(m.S,c||h?{title:h?"Something went wrong":"Success!",subtitle:h?"Please try again.":`You've successfully granted delegated action permissions to ${a}.`,icon:h?e.A:f.A,iconVariant:h?"error":"success",onBack:l,watermark:!0}:{title:"Enable offline access",subtitle:`By confirming, ${a} will be able to use your wallet for you even when you're not around. You can revoke this later.`,icon:g,primaryCta:{label:"Accept",onClick:j},secondaryCta:{label:"Not now",onClick:k},onBack:l,watermark:!0,children:(0,d.jsx)(i.W,{address:b,title:"Wallet"})}),o={component:()=>{let{data:a}=(0,l.a)(),b=(0,j.u)(),{closePrivyModal:c}=(0,k.u)(),[e,f]=(0,h.useState)(!1),[g,i]=(0,h.useState)(),{address:m,onDelegate:o,onSuccess:p,onError:q}=a.delegatedActions.consent,r=async()=>{e?p():q(g??new k.b("User declined delegating actions.")),c({shouldCallAuthOnSuccess:!1})};return(0,h.useEffect)(()=>{if(!e&&!g)return;let a=setTimeout(r,j.r);return()=>clearTimeout(a)},[e,g]),(0,d.jsx)(n,{appName:b.name,address:m,success:e,error:g,onAccept:async()=>{try{await o(),f(!0)}catch(a){i(a)}},onDecline:()=>{r()},onClose:r})}}},52481:(a,b,c)=>{c.d(b,{E:()=>e});var d=c(78858);let e=d.I4.span`
  text-align: left;
  font-size: 0.75rem;
  font-weight: 500;
