...
`},22903:(a,b,c)=>{c.r(b),c.d(b,{UpdateEmailScreen:()=>w,UpdateEmailScreenView:()=>v,default:()=>w});var d=c(21124),e=c(3420),f=c(27829),g=c(91402),h=c(38301),i=c(64317),j=c(95761),k=c(87230),l=c(23966),m=c(99848),n=c(44110),o=c(7797),p=c(70756),q=c(52481),r=c(74995);c(22967),c(18521),c(32571),c(21398),c(61946);let s=(0,h.forwardRef)((a,b)=>{let[c,e]=(0,h.useState)(""),[f,p]=(0,h.useState)(""),[r,s]=(0,h.useState)(!1),{authenticated:v,user:w}=(0,l.u)(),{initUpdateEmail:x}=(0,k.u)(),{navigate:y,setModalData:z,currentScreen:A}=(0,l.a)(),{enabled:B,token:C}=(0,j.a)(),D=(0,i.u)(),E=(0,n.D)(c)&&(D.disablePlusEmails&&c.includes("+")?(f||p("Please enter a valid email address without a '+'."),!1):(f&&p(""),!0)),F=r||!E,G=()=>{F||(!B||C||v?(async a=>{if(!w?.email)throw Error("User is required to have an email address to update it.");s(!0);try{await x({oldAddress:w.email.address,newAddress:c,captchaToken:a}),y("AwaitingPasswordlessCodeScreen")}catch(a){z({errorModalData:{error:a,previousScreen:A||"LandingScreen"}}),y("ErrorScreen")}s(!1)})(C):(z({captchaModalData:{callback:a=>{if(!w?.email)throw Error("User is required to have an email address to update it.");return x({oldAddress:w.email.address,newAddress:c,captchaToken:a})},userIntentRequired:!1,onSuccessNavigateTo:"AwaitingPasswordlessCodeScreen",onErrorNavigateTo:"ErrorScreen"}}),y("CaptchaScreen")))};return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsxs)(t,{children:[f&&(0,d.jsx)(q.E,{style:{marginTop:"0.25rem",textAlign:"left"},children:f}),(0,d.jsxs)(u,{$error:!!f,children:[(0,d.jsx)(m.C,{children:(0,d.jsx)(g.A,{})}),(0,d.jsx)("input",{ref:b,id:"email-input",type:"email",placeholder:"your@email.com",onChange:a=>e(a.target.value),onKeyUp:a=>{"Enter"===a.key&&G()},value:c,autoComplete:"email"}),a.stacked?null:(0,d.jsx)(o.E,{isSubmitting:r,onClick:G,disabled:F,children:"Submit"})]})]}),a.stacked?(0,d.jsx)(o.P,{loadingText:null,loading:r,disabled:F,onClick:G,style:{width:"100%"},children:"Submit"}):null]})}),t=p.I,u=p.E,v=({title:a="Update your email",subtitle:b="Add the email address you'd like to use going forward. We'll send you a confirmation code"})=>(0,d.jsx)(r.S,{title:a,subtitle:b,icon:e.A,watermark:!0,children:(0,d.jsx)(f.B,{children:(0,d.jsx)(s,{stacked:!0})})}),w={component:()=>(0,d.jsx)(v,{})}},27829:(a,b,c)=>{c.d(b,{B:()=>e,C:()=>h,F:()=>j,H:()=>g,R:()=>n,S:()=>l,a:()=>k,b:()=>m,c:()=>i,d:()=>o,e:()=>f});var d=c(78858);let e=d.I4.div`
  display: flex;
  flex-direction: column;
