 ...
 */
export const buyAgentDecision = {
    name: "BUY_AGENT_DECISION",
    similes: ["PAY_FOR_VERDICT", "X402_AGENT_QUERY", "PURCHASE_AGENT_DECISION"],
    description: "Pay 0.01 USDC via x402 to get a personalized stable-rotator verdict. Returns the 402 offer; settle via your wallet.",
    ...
    handler: async (runtime, message, _state, _options, callback) => {
        ...
        try {
            ...
            const lines = [
                `Stable-rotator decision is x402-paid:`,
                `· network: ${a.network}`,
                `· token: USDC (${a.asset})`,
